...
function datepicker(locals) {
  ...
  var dialogModeTimeFormatType = "24h";
  ...
  if (locals.config) {
    ...
    if (locals.config.dialogModeTimeFormatType) {
      dialogModeTimeFormatType = locals.config.dialogModeTimeFormatType;
    }
  ...
  var is24HrTimeFormat = dialogModeTimeFormatType === '24h' ? true : false;
